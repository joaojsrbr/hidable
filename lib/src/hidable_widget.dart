...
class _HidableState extends State<Hidable> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final hidable = widget.controllers.hidable(widget.preferredWidgetSize.height);
  ...
  Widget hidableCard(double factor, hidable) {
    return Align(
      ...
      child: SizedBox(
        ...
        height: hidable.size,
        child: widget.wOpacity ? Opacity(opacity: factor, child: widget.child) : widget.child,
      ),
    );
  }
